    ...
    <main>
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="row mt-3">
                    <div class="col-md-10">
                        <a href="<?= base_url(); ?>kolokium/inputNim" class="btn btn-primary"><i
                                class="fas fa-plus"></i> Tambah Jadwal Kolokium</a>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a href="<?= base_url(); ?>kolokium/pindahKolokium" class="dropdown-item"><i
                                        class="fas fa-table"></i> Data Pindahan</a>
                                <a href="<?= base_url(); ?>kolokium/hapusKolokium" class="dropdown-item"><i
                                        class="fas fa-table"></i> Data Hapus</a>
                            </div>
                        </div>
                        <a href="<?= base_url(); ?>kolokium/report" class="btn btn-success"><i
