...
<head>
   ...
   <link rel="stylesheet" href="<?php echo base_url() . 'assets/dateindo/css/bootstrap.min.css'?>"> 
 ...
 <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    <script src="<?php echo base_url() . 'assets/dateindo/js/jquery-1.11.3.min.js'?>"></script> 
    <script src="<?php echo base_url() . 'assets/dateindo/js/bootstrap-datetimepicker.js'?>"></script>
